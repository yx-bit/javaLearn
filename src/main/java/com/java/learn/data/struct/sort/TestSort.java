...
public class TestSort {
    public static void main(String[] args) {
        ...
        Integer[] arr=Integers.random(20000,1,200000);
        testSort(arr,new MergeSort(),new BubbleSort<Integer>(),new SelectionSort<Integer>(),new HeapSort<Integer>(),new InsertionSort<Integer>());
    }
